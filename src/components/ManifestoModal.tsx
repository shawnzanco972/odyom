          ...
          <section>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <StrategyCard
                ...
                body="משחקים מוקדם כשהסיכון אפסי (5%). הרצף בטוח, אך קלפים נמוכים עדיין על השולחן וקיים סיכוי גבוה ליפול על ניקוד נמוך."
              />
              <StrategyCard
                variant="error"
                title="🔴 המשוגעים (מהמרי הלילה)"
                body="מחכים ל-23:30 כשהמשחק מתכווץ ל-50/50 מול המוות. סיכון ענק למחוק את הסטריק, אך הניקוד מובטח להיות מקסימלי."
              />
            </div>
            <p className="text-xs md:text-sm font-bold text-gray-concrete text-center mt-2">
              רוב השחקנים יתמרנו איפשהו באמצע הטווח במהלך היום, ויאזנו בין הישרדות לחמדנות.
            </p>
          </section>
